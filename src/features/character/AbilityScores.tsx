...
const AbilityScores = ({ character }: Props) => {
  return (
    <div className="flex text-center flex-wrap sm:flex-no-wrap">
      {Object.entries(CHARACTER_STATS).map(([key, value]) => {
        const score = calculateStats(character)[key as StatsTypes];
        const mod = getAbilityMod(score);
        return (
          <>
            <div className="mr-1 relative w-20 h-20 bg-yellow-100 dark:bg-primary-dark custom-border flex flex-col items-center">

...
const LevelUp = ({ character, readonly }: Props) => {
  ...
  return (
    <button
      ...
      className="bg-secondary-light hover:bg-yellow-100 dark:bg-tertiary-dark dark:text-primary-light dark:hover:bg-primary-dark cursor-pointer flex justify-center lg:ml-1 custom-border custom-border-medium h-20 w-full lg:w-20"
    >
      <div

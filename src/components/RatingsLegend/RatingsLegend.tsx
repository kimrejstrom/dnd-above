...
const RatingsLegend = (props: Props) => {
  return (
    <details>
      <summary className="text-sm">Ratings</summary>
      <div className="dnd-body text-xs">
        <div className="flex items-center mt-1">
          ...
          <div>
            Fantastic options, often essential to the function of your
            character.
          </div>
        </div>
        <div className="flex items-center mt-1">
        ...
        <div className="flex items-center mt-1">
          ...
          <div>
            Decent options, par for the course. Not great, not terrible.
          </div>
        </div>
        <div className="flex items-center mt-1">
          <img

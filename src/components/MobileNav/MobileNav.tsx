  ...
  return (
    <footer className="bg-light-100 dark:bg-dark-100">
      <nav className="z-50 border-t-2 border-dark-300 dark:border-light-100 bg-light-200 dark:bg-dark-200 fixed bottom-0 w-full md:hidden flex items-center justify-between p-2">
        ...
        <NavLink className="border-none dark:text-yellow-200" exact to="/">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <NavLink className="border-none dark:text-yellow-200" to="/characters">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <NavLink className="border-none dark:text-yellow-200" to="/tools">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"

    ...
    <>
      ...
      <div className="w-full flex flex-wrap justify-center">
        ...
        <button
          ...
          className="w-44 md:w-48 mt-1 mr-1 px-2 bg-light-300 dark:bg-dark-100 text-center h-72 flex justify-center items-center flex-col custom-border custom-border-thin"
        >
